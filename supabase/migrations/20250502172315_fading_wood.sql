/*
  # Update Certificate Date Handling and Display
...
-- Drop existing functions to avoid conflicts
DROP FUNCTION IF EXISTS format_certificate_date(timestamptz);
DROP FUNCTION IF EXISTS get_friday_between_march_10_20(integer);
