/*
  # Create Certificates Table and Import Data
  ...
  1. New Tables
    - `certificates`
      ...
      - `name` (text, not null)
      - `rut` (text, default '')
      - `career` (text, default 'No declarada')
...
CREATE TEMP TABLE temp_certificates_import (
    id bigint PRIMARY KEY,
    name text NOT NULL,
    rut text,
    career text,
...
-- Insert the certificate data
INSERT INTO temp_certificates_import (id, name, rut, career, created_at, qr_url, view_url, graduation_year, estado, whatsapp) VALUES
...
-- Import data from temporary table
...
DROP TABLE temp_certificates_import;